...
public class C62_ExceptionTest {
	...
	public static void main(String[] args) {
		...
		//Exception 예시1 : java.lang.NullointterException (객체 참조가 null 이면 메소드 실행 못합니다.)
				String message = null;
				...
				//		int a = sc.nextInt();			//키보드입력을 정수로 변환해서 변수에 저장합니다.
						...
						//숫자 외에 다른 문자 입력하면 Exception발생 : jave.lang.NumberFormatException
 ...
 문법오류 : int a=4.1;와 같이 컴파일 자체가 안됩니다.
