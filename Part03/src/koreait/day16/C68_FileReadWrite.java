...
public class C68_FileReadWrite {
	//main 메소드가 throws Exception 한다면 jvm에게 넘깁니다. 처리내용은 printStackTrace겨로가와 동일
	public static void main(String[] args) throws FileNotFoundException{

		String filename = "/Users/a/Desktop/iclass05/자바테스트0617.txt";
		
		try {
				fileWrite2(filename);
			//	filename = "/Users/a/Desktop/iclass05/자바테스트0618.txt"; //없는 파일 테스트용
				fileRead(filename);
	...
	//방법 1: Exception을 try~ catch로 직접처리합니다.
	public static void fileWrite(String filename) {
				
		File file = new File(filename);

				PrintWriter pw = null;
//생성자 메소드 java.io.PrintWriter.PrintWriter(File file) throws FileNoeFoundException
				try {
	...
	//방법2 : throws 키워드는 해당 Exception을 호출한 곳(여기서는 main 메소드)으로 넘긴다.
