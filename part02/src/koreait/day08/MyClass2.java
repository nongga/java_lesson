...
public class MyClass2 {
	...
	//						3)접근한정자는 4가지 모두 가능 : 지금 예시는 기본package
	...
	//참고 : 커스텀 생성자를 정의하고 기본생성자 허용하지 않는 경우 많습니다.
 ...
 * ->생성자 메소드 실행으로 객체가 만들어집니다. Random r = new Random();에서 Random() 이 생성자 메소드이고 객체를 만들기 위해 실행되는 메소드입니다.
 * ->기본생성자 : 인자가 없는 형식의 생성자
 * ->커스텀 생성자 : 필드값 초기화를 위해서 인자가 있는 형식의 생성자
 */
